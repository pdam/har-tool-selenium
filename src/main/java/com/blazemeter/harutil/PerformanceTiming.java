...
public class PerformanceTiming {
    ...
    public PerformanceTiming(WebDriver driver, Har har) {
        Map<String, Long> timing = (Map<String, Long>) ((RemoteWebDriver) driver).executeScript("return window.performance.timing;");
        ...
        String href = (String) ((RemoteWebDriver) driver).executeScript("return window.location.href;");
        if (href.contains("#")) {
        ...
        if (page != null) {
            page.setTitle((String) ((RemoteWebDriver) driver).executeScript("return window.document.title;"));
